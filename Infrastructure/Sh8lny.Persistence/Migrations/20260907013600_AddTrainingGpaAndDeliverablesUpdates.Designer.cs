...
namespace Sh8lny.Persistence.Migrations
{
    ...
    [Migration("20260907013600_AddTrainingGpaAndDeliverablesUpdates")]
    partial class AddTrainingGpaAndDeliverablesUpdates
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sh8lny.Domain.Models.Application", b =>
                {
                    ...
                    b.Property<string>("StudentCvUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Sh8lny.Domain.Models.DashboardMetric", b =>
                {
                    ...
                    b.Property<int>("BannedUsers")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);

                    b.Property<int>("ClosedProjects")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<int>("CompletedApplications")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<int>("NewProjectsLast30Days")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
                    ...
                    b.Property<decimal>("TotalTransactionVolume")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("decimal(18,2)")
                        .HasDefaultValue(0m);
            ...
            modelBuilder.Entity("Sh8lny.Domain.Models.SubmissionFile", b =>
                {
                    ...
                    b.HasIndex("TrainingSubmissionID")
            ...
            modelBuilder.Entity("Sh8lny.Domain.Models.TrainingSubmission", b =>
                {
                    ...
                    b.Property<bool>("IsExternalTraining")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Sh8lny.Domain.Models.SubmissionFile", b =>
                {
                    b.HasOne("Sh8lny.Domain.Models.TrainingSubmission", "TrainingSubmission")
                        .WithMany("SubmissionFiles")
                        .HasForeignKey("TrainingSubmissionID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("TrainingSubmission");
                });
